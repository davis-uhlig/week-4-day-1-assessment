...
/*************************************************************************************
------------ ANSWER -------------------
no x and y are opposite of what they claim to be
...
/**************************************************************************************
------------ ANSWER -------------------
Inside the IFEE the console.log will print 4 because it is part of the local scope.
The console.log(add) on the outside will give an error because it cannot access the const within an IFEE
**************************************************************************************/
